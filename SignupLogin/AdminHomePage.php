...
if (isset($_SESSION["user_id"])){
    ...
    $sql = "SELECT * FROM user
            ...
            //to redirect non-admin to user homepage
            if ($user["IS_ADMIN"] == 0){
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Styles/AdminHomePage.css" />
...
<nav class="navbar">        
        ...
        <ul class="nav-list" id="navi-list">
            <li class="list-item">
                <a href="#" onclick="document.getElementById('admin-modal').style.display='block'">Add User</a>
    ...
    <?php
        $sql2 = "SELECT ID, USERNAME, FNAME, LNAME, COUNTRY, MSTATUS, KIDS, EMAIL, IS_ADMIN FROM user";
        ...
        <div class="modal-content">
            ...
            <form class="login-form" action="AdminValidation.php" id="signup" method="post">

            <div id="acctype">
          <p>Account Type:</p>
          <label for="isAdmin">Administrator</label>
          <input type="radio" name="adminStatus" id="isAdmin" value = "1" />      
          
          <label for="notAdmin">Standard User</label>
          <input type="radio" name="adminStatus" id="notAdmin" value = "0" />
            </div>
          ...
          <label for="kids">Number of Kids</label>
            <input type="number" style="text-align: center;" min="0" id="kids" name="kids" placeholder="Num" >
