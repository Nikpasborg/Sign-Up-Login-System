...
<html>
  ...
  <nav class="navbar">        
    ...
    <div class="container">
      <h1>Signup Form</h1>
      <form class="signup-form" action="SignUpValidation.php" id="signup" method="post"> 
        <div>
        ...
        <div>
          <label for="kids">Number of Kids</label>
            <input type="number" style="text-align: center;" min="0" id="kids" name="kids" placeholder="Num" required>
        </div>
        <div>
